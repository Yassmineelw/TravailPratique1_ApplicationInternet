    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col" class="picture"><?= __('Picture') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                if(isset($company->files[0])){
                    
                    echo $this->Html->image($company->files[0]->path . $company->files[0]->name, [
                        "alt" => $company->files[0]->name,
                        "width" => "220px",
                        "height" => "150px",
                        'url' => ['controller' => 'Files', 'action' => 'view', $company->files[0]->id]                        
                    ]);
                }
                ?>
                </td>
